...
public class DeleteModel : BasePageModel
{
    ...
    public DeleteModel(ITotalSaleApplication application, IUserApplication user, IProductApplication product)
    {
        _user = user;
        _product = product;
    ...
    public async Task<IActionResult> OnPostAsync(Guid? id)
    {
        ...
        var res = (await _application.DeleteTotalSale(id.Value));
